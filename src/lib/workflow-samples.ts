...
export const WORKFLOW_SAMPLES: WorkflowSample[] = [
  {
    ...
    steps: [
      ...
      { id: "review", role: "Review and finalize", agentId: "sage", instruction: "Review the draft for accuracy and impact, then output the improved final version only.", criteria: "Outputs only the final improved version. Any commentary, critique list, or meta explanation is a failure." },
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "review", role: "Tighten", agentId: "scribe", instruction: "Cut every sentence that does not carry an argument, then output the final version only.", criteria: "Outputs only the final version and is shorter than the draft it received." },
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "review", role: "Fact-check", agentId: "sage", instruction: "Remove any claim not supported by the research, then output the final brief only.", criteria: "Outputs only the final brief and contains no claim absent from the earlier steps." },
    ],
  },
  {
    ...
    steps: [
      ...
      { id: "review", role: "Final pass", agentId: "scribe", instruction: "Remove repetition and output the final guide only.", criteria: "Outputs only the final guide with no commentary and no duplicated instruction." },
    ],
  },
]
